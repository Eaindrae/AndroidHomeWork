...
import com.padcmyanmar.padc9.padc_9_helloandroid.R;
...
public class UIComponents2Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button btnStartUIComponent1 = findViewById(R.id.btn_intent);
        btnStartUIComponent1.setOnClickListener(new View.OnClickListener(){


            @Override
            public void onClick(View view) {
                Intent intent =ActivityTest.newIntent(getApplicationContext());
